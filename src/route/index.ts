...
import RedirectToUserManagement from '@/components/RedirectToUserManagement'
    ...
    children: [
      {
        ...
        children: [
          {
            index: true,
            Component: RedirectToUserManagement,
          },
          {
          ...
          },
          {
            ...
            lazy: () =>
              import('@/pages/user-management/SellerApplication').then(
                module => ({
                  Component: module.default,
                })
              ), // 판매자 신청 관리 페이지
          ...
          },
          {
            ...
            lazy: () =>
              import('@/pages/product-management/BadgeManagement').then(
                module => ({
                  Component: module.default,
                })
              ), // 뱃지 관리 페이지
