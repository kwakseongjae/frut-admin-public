...
import Icon1 from '@/assets/svg/ic_purchase_management1.svg'
import Icon2 from '@/assets/svg/ic_purchase_management2.svg'
import Icon3 from '@/assets/svg/ic_purchase_management3.svg'
import Icon4 from '@/assets/svg/ic_purchase_management4.svg'
import Icon5 from '@/assets/svg/ic_purchase_management5.svg'
import Icon6 from '@/assets/svg/ic_purchase_management6.svg'
        ...
        <div className="grid grid-cols-6 gap-4">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-start justify-between mb-4">
              <div className="text-sm font-medium text-black">전체 주문</div>
              <div className="w-10 h-10 rounded-full bg-[#3A7BFF]/20 flex items-center justify-center flex-shrink-0">
                <img src={Icon1} alt="전체 주문" className="w-6 h-6" />
              </div>
            </div>
            <div className="text-2xl font-bold text-black mb-1">
              {summaryStats.totalOrders}
            </div>
            <div className="text-xs text-[#9E9E9E]">총 주문 건수</div>
          </div>

          {/* 입금 대기 */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-start justify-between mb-4">
              <div className="text-sm font-medium text-black">입금 대기</div>
              <div className="w-10 h-10 rounded-full bg-[#F59E0B]/20 flex items-center justify-center flex-shrink-0">
                <img src={Icon2} alt="입금 대기" className="w-6 h-6" />
              </div>
            </div>
            <div className="text-2xl font-bold text-black mb-1">
              {summaryStats.depositPending}
            </div>
            <div className="text-xs text-[#9E9E9E]">입금 대기중</div>
          </div>

          {/* 배송 준비 */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-start justify-between mb-4">
              <div className="text-sm font-medium text-black">배송 준비</div>
              <div className="w-10 h-10 rounded-full bg-[#4FD1C5]/20 flex items-center justify-center flex-shrink-0">
                <img src={Icon3} alt="배송 준비" className="w-6 h-6" />
              </div>
            </div>
            <div className="text-xl font-semibold text-black mb-1">
              {summaryStats.preparing}
            </div>
            <div className="text-xs text-[#9E9E9E]">배송 준비중</div>
          </div>

          {/* 배송 중 */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-start justify-between mb-4">
              <div className="text-sm font-medium text-black">배송 중</div>
              <div className="w-10 h-10 rounded-full bg-[#A855F7]/20 flex items-center justify-center flex-shrink-0">
                <img src={Icon4} alt="배송 중" className="w-6 h-6" />
              </div>
            </div>
            <div className="text-2xl font-bold text-black mb-1">
              {summaryStats.shipping}
            </div>
            <div className="text-xs text-[#9E9E9E]">배송 진행중</div>
          </div>

          {/* 배송완료 */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-start justify-between mb-4">
              <div className="text-sm font-medium text-black">배송완료</div>
              <div className="w-10 h-10 rounded-full bg-[#22C55E]/20 flex items-center justify-center flex-shrink-0">
                <img src={Icon5} alt="배송완료" className="w-6 h-6" />
              </div>
            </div>
            <div className="text-2xl font-bold text-black mb-1">
              {summaryStats.delivered}
            </div>
            <div className="text-xs text-[#9E9E9E]">완료된 주문</div>
          </div>

          {/* 총 매출 */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-start justify-between mb-4">
              <div className="text-sm font-medium text-black">총 매출</div>
              <div className="w-10 h-10 rounded-full bg-[#0EA5E9]/20 flex items-center justify-center flex-shrink-0">
                <img src={Icon6} alt="총 매출" className="w-6 h-6" />
              </div>
            </div>
            <div className="text-2xl font-bold text-black mb-1">
              {formatPrice(summaryStats.totalSales)}원
            </div>
            <div className="text-xs text-[#9E9E9E]">입금완료 기준</div>
          </div>
        </div>
      )}
